...
public class EInfo extends JPanel {
    ...
    private final JLabel label_tours;
    // Label contenant le pourcentage de tuiles non-inondée
    private final JLabel label_tuiles_inondees;
    // Label contenant le pourcentage de tuiles restantes
    private final JLabel label_tuiles_restantes;
    // Label contenant le message important
    private final JLabel label_alerte;
     ...
     *
     * @param tresors La collection avec l'état des trésors
     * @param nbTours nombre d'actions restantes
     * @param tuiles_non_inondees le % de tuile non inondées
     * @param tuiles_restantes le % de tuile restantes
     * @param message_alerte le message à afficher
     */
