...
public class EInfo extends JPanel {
    ...
    public EInfo() {
        ...
        this.label_tours = new JLabel("Nombre d'actions restants : 3");
     ...
     * @param tresors
     * @param nbTours
     * @param tuiles_non_inondees
     * @param tuiles_restantes
     * @param message_alerte
     */
    public void update(HashMap<Utils.Tresor, Boolean> tresors, int nbTours, int tuiles_non_inondees, int tuiles_restantes, String message_alerte) {
        ...
        label_tours.setText("Nombre d'actions restantes : " + nbTours);
